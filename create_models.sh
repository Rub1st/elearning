...
rails g model User login:string password:string email:string fullname:string birthday:string user_role:integer --force
...
rails g model Page course:references content:text --force
