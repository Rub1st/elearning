  ...
  const entities = [
    {
      ...
      name: "Courses",
      to: "/courses",
      badgeContent: props.courses.filter(
        (el) => el.approve_status === "pending"
      ).length,
    },
    {
      id: 1,
      name: "Users",
      to: "/users",
      badgeContent: props.users.filter((el) => el.user_status === "pending")
        .length,
    },
    {
      id: 2,
      name: "Organizations",
      to: "/organizations",
      badgeContent: props.organizations.filter(
        (el) => el.approve_status === "pending"
      ).length,
    },
    ...
    <div>
      ...
      <div className="general-row">
        ...
        <div className="field-position">
          {!props.connect_status ? <CircularProgress /> : props.children}
        </div>
      </div>
    </div>
  );
