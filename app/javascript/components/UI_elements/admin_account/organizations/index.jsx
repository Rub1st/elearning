...
let orgFilter = (orgs, status) =>
  orgs.filter((el) => el.approve_status === status);
                  ...
                  {orgFilter(props.organizations, "pending").map((el) => (
                    <li key={el.id} className="admin-course-list-position">
                      <OrganizationItem
                        ...
                        newEl2={{
                          id: el.id,
                          organization: { approve_status: 2 },
                        }}
                        newEl={{
                          id: el.id,
                          organization: { approve_status: 1 },
                        }}
                      />
                    </li>
                  ))}
