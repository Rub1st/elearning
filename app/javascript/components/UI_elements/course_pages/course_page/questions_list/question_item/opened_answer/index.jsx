...
const OpenedAnswer = (props) => {
  ...
  return(
      ...
      <ul>
        {
          ...
          key={el.id}>
            <Checkbox
              ...
              onChange={() => setUserAnswers( userAnswers.includes(el) ?
                userAnswers.filter(e => e.id !== el.id) : [...userAnswers, el] )}
            />
            <span>
              {el.value}
            </span>
    ...
    <IconButton disabled={!userAnswers.length}
      onClick={() => userAnswers.map( e => props.post({
