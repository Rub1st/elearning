...
const Settings = (props) => {
  ...
  return (
    <div className="home__position">
      <div
        style={{ marginLeft: "-50px", marginTop: "30px", marginBottom: "30px" }}
        className="home__top-line"
      >
        <input
        ...
        <Avatar
          ...
          src={
            props.users.find((e) => e.id === props.currentUser.id).avatar_url
          }
        />
        <div style={{ marginLeft: "-40px" }} className="home__main-user-info">
          <TextField
            ...
            helperText={
              props.errors.login != undefined ? props.errors.login[0] : null
            }
            value={login}
            variant="outlined"
          ...
          <TextField
            ...
            helperText={
              props.errors.full_name != undefined
                ? props.errors.full_name[0]
                : null
            }
            value={fullName}
            variant="outlined"
      ...
      <div style={{ marginLeft: "-50px" }} className="home__top-line">
        ...
        <embed
          src={
            props.users.find((e) => e.id === props.currentUser.id)
