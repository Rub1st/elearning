    ...
    <div className="profile-window">
      ...
      <div className="profile-field">
        <Switch>
          ...
          <Route
            exact
            path={`${path}current_courses`}
            component={CurrentCourses}
          />
          <Route
            exact
            path={`${path}favorite_courses`}
            component={FavoriteCourses}
          />
          <Route
            exact
            path={`${path}recomended_courses`}
          ...
          <Route
            exact
            path={`${path}manage_organization_id=${props.currentOrganization.id}`}
            component={OrganizationManaging}
          />
        </Switch>
      </div>
    </div>
