    ...
    <div className="profile__course-field">
      <div className="d-flex">
        ...
        <ul className="profile__course-list">
          {props.currentCourses.length ? (
            props.currentCourses.map((el) => (
        ...
        <button
          className="arrow-button"
          disabled={props.currentCourses.length !== 3}
          onClick={() => {
            setCurrentPage(currentPage + 1);
            props.set(getsCurrentCourses, currentPage + 1);
          }}
...
export default connect(
  ...
  (dispatch) => ({
    ...
    set: (setter, currrentPage) =>
      dispatch(getCurrentCourses(setter, currrentPage)),
  })
)(CurrentCourses);
