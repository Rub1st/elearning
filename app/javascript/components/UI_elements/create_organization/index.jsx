...
const CreateOrganization = (props) => {
  ...
  return (
    <div className="create-organization-window">
      <div className="create-organization-label">{t("Organization.1")}</div>
          ...
          <div className="d-flex">
            <ul className="choose-managers-list">
              {props.users.length ? (
                props.users.map((el) => (
                  <ListItem key={el.id} button>
                    <Checkbox
                      ...
                      onChange={() =>
                        setManagers(
                          managers.includes(el)
                            ? managers.filter((e) => e.id !== el.id)
                            : [...managers, el]
                        )
                      }
                    />
                ...
                <div className="empty_field">{t("EmptyField.9")}</div>
              )}
            </ul>
