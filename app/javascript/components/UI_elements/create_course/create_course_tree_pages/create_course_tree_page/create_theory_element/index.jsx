    ...
    <div style={{ marginTop: "15px" }}>
      <div>
        <TextField
          ...
          placeholder={t("Course.Placeholders.4")}
        />
        <input
          accept="image/*"
        ...
        {image !== null ? <p>{t("Course.20")}</p> : null}
      </div>
      <div style={{ marginTop: "15px" }} className="d-flex">
        <TextField
          ...
          placeholder={t("Course.Placeholders.5")}
        />
        <Tooltip title={t("Tooltip.20")}>
          <IconButton
            disabled={!subtitle.length && !content.length && image === null}
            onClick={() => {
