...
const PageReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case CREATE_PAGE: {
      ...
      return {
        ...state,
        pages: [...state.pages, action.value],
        currentDraftPage: action.value,
      };
    }
    case UPDATE_PAGE: {
      ...
      return {
        ...
        pages: [
          action.value,
          ...state.pages.filter((el) => el.id !== action.value.id),
        ],
        currentDraftPage: action.value,
      };
    }
    ...
    case SET_CURRENT_DRAFT_PAGE: {
      return {
        ...state,
        currentDraftPage: state.pages.find((el) => el.id === action.value),
      };
    }
    default: {
      return state;
