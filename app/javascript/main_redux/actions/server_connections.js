...
export const getMyCourses = (setter, page) => (dispatch) => {
  axios
    .get(`http://localhost:3000/courses/my_courses?current_page=${page}`)
    .then((response) => {
      dispatch(setter(response.data));
...
export const getRecommendedCourses = (setter, page) => (dispatch) => {
  axios
    .get(
      `http://localhost:3000/courses/recommended_courses?current_page=${page}`
    )
    .then((response) => {
      dispatch(setter(response.data));
      dispatch(setErrors([]));
...
export const getDataWithQuery = (id, path, setter) => (dispatch) => {
  axios
    .get(`http://localhost:3000/${path}?parent_id=${id}`)
    .then((response) => {
      dispatch(setter(response.data));
      dispatch(setErrors([]));
    })
...
export const destroyDataElementWithQuery = (id, parrentId, path, setter) => (
  dispatch
) => {
  axios
    .delete(`http://localhost:3000/${path}/${id}?parent_id=${parrentId}`, {
      "Content-Type": "application/x-www-form-urlencoded",
    })
    .then((response) => {
      dispatch(setter(response.data));
...
//update
export const updateDataElementWithFormData = (obj, id, path, setter) => (
  dispatch
) => {
  axios
    .put(`http://localhost:3000/${path}/${id}`, obj, {
      "Content-Type": "application/x-www-form-urlencoded",
    })
    .then((response) => {
      dispatch(setter(response.data));
...
export const connectOrganizations = (id, setter) => (dispatch) => {
  axios
    .post(`http://localhost:3000/users/${id}/connect_organizations`, {
      "Content-Type": "application/x-www-form-urlencoded",
    })
    .then((response) => {
      dispatch(setter(response.data));
...
export const postDataElementWithQuery = (obj, parrentId, path, setter) => (
  dispatch
) => {
  axios
    .post(`http://localhost:3000/${path}?parent_id=${parrentId}`, obj, {
      "Content-Type": "application/x-www-form-urlencoded",
    })
    .then((response) => {
      dispatch(setter(response.data));
...
export const searchData = (query, path, setter) => (dispatch) => {
  axios
    .get(`http://localhost:3000/${path}/search?term=${query}`)
    .then((response) => {
      dispatch(setter(response.data));
      dispatch(setErrors([]));
    })
...
export const searchDataPagination = (
  query,
  page,
  count_per_page,
  path,
  ...
  axios
    .get(
      `http://localhost:3000/${path}/search?term=${query}&current_page=${page}&count_per_page=${count_per_page}`
    )
    .then((response) => {
      dispatch(setter(response.data));
      dispatch(setErrors([]));
...
export const getDataPagination = (path, page, count_per_page, setter) => (
  dispatch
) => {
  axios
    .get(`http://localhost:3000/${path}?current_page=${page}`)
    .then((response) => {
      dispatch(setter(response.data));
      dispatch(setErrors([]));
    })
...
export const getDataWithQueryPagination = (
  parrentId,
  page,
  count_per_page,
  path,
  ...
  axios
    .get(
      `http://localhost:3000/${path}?current_page=${page}&count_per_page=${count_per_page}&parent_id=${parrentId}`
    )
    .then((response) => {
      dispatch(setter(response.data));
      dispatch(setErrors([]));
...
export const getDoneCourses = (setter, page) => (dispatch) => {
  axios
    .get(`http://localhost:3000/user_courses/done_courses?current_page=${page}`)
    .then((response) => {
      dispatch(setter(response.data));
      dispatch(setErrors([]));
    })
...
export const getCurrentCourses = (setter, page) => (dispatch) => {
  axios
    .get(
      `http://localhost:3000/user_courses/current_courses?current_page=${page}`
    )
    .then((response) => {
      dispatch(setter(response.data));
      dispatch(setErrors([]));
...
export const getFavoriteCourses = (setter, page) => (dispatch) => {
  axios
    .get(
      `http://localhost:3000/user_courses/favorite_courses?current_page=${page}`
    )
    .then((response) => {
      dispatch(setter(response.data));
      dispatch(setErrors([]));
